...
{{--                    Esto podríamos personalizarlo como hemos hecho en AppServiceProvider.php pero no voy a hacerlo por ahora--}}
                    @can
...
{{--Componente que carga flash.blade.php -> relacionado con cargar un mensaje si ha habido un registro satisfactorio--}}
<x-flash/>
